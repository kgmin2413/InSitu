...
OBJECT_ID = "chair_a4true_masked_30000_aruco_20260611"
A4_DATASET = ROOT / "third_party/InSitu-A4/data/chair_insitu_a4true_masked_20260611"
A4_MARKER_IMAGE_DATASET = ROOT / "third_party/InSitu-A4/data/chair_insitu_a4true_20260611"
A4_MODEL = ROOT / "third_party/InSitu-A4/output/chair_insitu_a4true_masked_result_20260611"
...
def main() -> int:
    ...
    write_json(
        output_dirs["debug"] / "frame_selection_report.json",
        {
            ...
            "method": "InSitu-A4 preprocess_video.py --fps 4, then RGB masked for COLMAP and RGBA alpha for train",
    ...
    write_json(
        ...
        {
            "status": "success",
            "method": "rembg via InSitu-A4 preprocess_video.py; applied to COLMAP images and 3DGS alpha",
    ...
    write_json(
        ...
        {
            "object_id": OBJECT_ID,
            "preset": "a4true_masked_colmap_train_aruco_metric",
            "timing_sec": timing,
