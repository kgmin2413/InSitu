...
OBJECT_ID = "chair_a4pose_fgmask_pruned_30000_aruco_20260611"
...
RAW_PLY = A4_MODEL / "point_cloud/iteration_30000/point_cloud_maskvote_pruned.ply"
...
def main() -> int:
    ...
    write_json(
        ...
        {
            "object_id": OBJECT_ID,
            "preset": "a4_full_pose_fgseed_alpha_bgpenalty_maskvote_pruned_aruco_metric",
            "timing_sec": timing,
