...
OBJECT_ID = "chair_a4pose_fgmask_30000_aruco_20260611"
...
def main() -> int:
    ...
    config = {
        ...
        "scale_estimation": {
            ...
            "foreground_filter": {"enabled": True, "min_observations": 2, "alpha_threshold": 128},
    ...
    write_json(
        ...
        {
            "object_id": OBJECT_ID,
            "preset": "a4_full_pose_fgseed_alpha_bgpenalty_aruco_metric",
            "timing_sec": timing,
